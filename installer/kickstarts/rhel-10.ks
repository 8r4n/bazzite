# Kickstart for deploying the RHEL 10 ostree-container image built by this repository.
#
...
ostreecontainer --url=ghcr.io/<your-github-owner>/bazzite-custom-gnome-r10s:stable --transport=registry
